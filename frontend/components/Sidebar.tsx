...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 border-t border-gray-800 px-2 py-2">
        <button
          type="button"
          onClick={onOpenSettings}
          title="설정"
          aria-label="설정"
          className={`flex h-9 shrink-0 items-center gap-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 ${
            collapsed ? "w-9" : "w-full"
          }`}
        >
          <span className="flex h-9 w-9 shrink-0 items-center justify-center">
